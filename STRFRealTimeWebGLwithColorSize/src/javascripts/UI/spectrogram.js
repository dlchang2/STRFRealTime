...
var spec3D = {
  ...
  draw_: function() {
    ...
    //dlchang use setTimeout as hack to fix fft computation frequency at 60 Hz
    setTimeout(function(){spec3D.analyserView.doFrequencyAnalysis();
    requestAnimationFrame(spec3D.draw_.bind(spec3D));},1000/60);
  },
