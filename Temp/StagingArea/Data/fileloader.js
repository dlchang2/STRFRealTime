...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 12649745;
      var PACKAGE_UUID = '612ce0ba-7dee-4ea8-8f70-dd758714123a';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    new DataRequest(31412, 170208, 0, 0).open('GET', '/level0');
    new DataRequest(170208, 170227, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(170227, 170392, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(170392, 197132, 0, 0).open('GET', '/resources.assets');
    new DataRequest(197132, 9675048, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(9675048, 11064020, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(11064020, 12561392, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(12561392, 12622120, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(12622120, 12649745, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
