        ...
        (function(r, s, o, a, l, u, h, d, g) {
            ...
            AnalyserView = function(e) {
                ...
                if (!this.freqByteData || this.freqByteData.length != this.analyser.frequencyBinCount) {
                    ...
                    strfRequest = new XMLHttpRequest, strfRequest.open("GET", "https://dl.dropboxusercontent.com/u/88928303/STRFMatNoEdgeRescaled.bin", !0), strfRequest.responseType = "arraybuffer", strfRequest.onload = function(e) {}, strfRequest.addEventListener("load", function(e) {
                ...
                switch (freqByteData = this.freqByteData, this.analysisType) {
                    ...
                    case w:
                    case b:
                        for (this.analyser.smoothingTimeConstant = 0,
                            this.analyser.getByteFrequencyData(freqByteData), i = 0; i < 36; i++) freqDataBuffer[i + 1] = freqDataBuffer[0];
                        for (freqDataBuffer[0] = freqByteData, c = 0; c < 256; c++) {
                            for (gridResponse[c] = 0, t = 0; t < 37; t++)
                                for (f = 0; f < 185; f++) gridResponse[c] += freqDataBuffer[t][f] * channelStrfs[c][t][f];
                            gridResponse[c] = 0.05*Math.pow(1.3,gridResponse[c]*1e-1);
                        }
                        break;
                    case v:
                ...
                var e = function() {
                    ...
                    n = function() {
                        ...
                        e.attached(), $(".music-box__tool-tip").hide(0), $("#loadingSound").hide(0), $(".music-box__buttons__button").click(function(t) {
                            e.startRender();
                            e.isPlaying();
                            e.stop(), e.drawingMode = !1, $(this).hasClass("selected") ? $(".music-box__buttons__button").removeClass("selected") : ($(".music-box__buttons__button").removeClass("selected"), $(this).addClass("selected"), void 0 !== $(this).attr("data-mic") ? window.isIOS ? (window.parent.postMessage("error2", "*"), $(this).removeClass("selected")) : ($("#record").fadeIn().delay(2e3).fadeOut(), e.live()) : void 0 !== $(this).attr("data-draw") ? (e.drawingMode = !0, $("#drawAnywhere").fadeIn().delay(2e3).fadeOut()) : void 0 !== $(this).attr("data-src") && (e.loopChanged(!0), $("#loadingMessage").text($(this).attr("data-name")), e.play($(this).attr("data-src"))))
                        })
                    },
                    r = $("#iosButton");
